...
public class Main {
    public static void main(String[] args) {
                ...
                // Test 0: Spawn N threads and test a series of M random operations; N = numWorkers, M = numOps
                int numWorkers = 16;
                Threads hashtable = new Threads();
                Thread[] workerThreads = new Thread[numWorkers];
        
                int numOps = hashtable.numOps.get();
                ...
                System.out.println("Number of random operations: " + numOps);
                System.out.println("Number of threads: " + numWorkers);
                System.out.println("Execution time in ms: " + time);
                System.out.println("Execution time: " + min + " mins, " + sec + " secs and " + ms + " ms");
